...
where $\vec{\omega}=(\cos\theta,\sin\theta)\in\mathbb{S}^1$. The X-ray transform of a function $f$ of $(x,y)=\mathbb{R}^2$ is defined by 

$\mathcal{R}_1f(\gamma)=\mathcal{R}_1f(\theta,t)
:=\int_\gamma f=\int_{-\infty}^\infty f(t\cos\theta-s\sin\theta,t\sin\theta+s\cos\theta)ds,$

Note that $\mathcal{R}_1f(\theta+\pi,-t)=\mathcal{R}_1f(\theta,t)$.
"""
...
# ╔═╡ 38ea56dd-c2f9-4a67-af20-c01234fbee5b
begin
nbsp = html"&nbsp"
end
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "14c6e42a74349f089cdac6b9f4078d526f95380b"
...
git-tree-sha1 = "64349f52130b3cf2ba2620a7b1a02581788822de"
